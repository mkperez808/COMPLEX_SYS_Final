...
def createData(raw_data_path, writePath, lexiconPath, item_set, data_type):
...
def main():
    ...
    # create_folds(k_SS_path, overwrite)
    # createWavScp(rawDataPath=raw_data_path, kaldiPath=k_SS_path, itemSet=all_set)
    # createData(raw_data_path, k_SS_path, lexiconPath, all_set, 'SS')
    ...
    createData(raw_data_path, k_phone_path, lexiconPath, all_set, 'Phonation')
